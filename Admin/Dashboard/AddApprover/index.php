...
if(!mysqli_connect_error()){
	if(isset($_POST["addApprover"])){
		if(
			...
			$query="INSERT INTO ".$APPROVERTABLENAME." (`approverUsername`, `approverPasswordHash`) VALUES ('{$_POST['username']}','{$md5Hash}')";
	...
	<div class="container">
		...
		<form method="POST" class="card" style="padding: 20px;">
		  <div class="form-group">
		    <label for="exampleInputEmail1">Username for new approver </label>
		    ...
		    <small id="emailHelp" class="form-text text-muted">New approver will be using these credentials to login</small>
		  </div>
		  <div class="form-group">
		    <label for="exampleInputPassword1">Password for new approver</label>
		    <input type="text" name="password" class="form-control" id="exampleInputPassword1" placeholder="Password" required autocomplete="off">
		  </div>
		  <input type="submit" name="addApprover" class="btn btn-primary" value="Add Approver" style="font-weight: bold;">
		</form>
	</div>
