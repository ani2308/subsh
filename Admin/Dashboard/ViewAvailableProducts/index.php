...
<body>
	...
	<div class="alert alert-primary" role="alert" style="margin: 10px;">
	  <h4><u>View Available Products</u></h4>
	</div>
	...
	<table border="2px solid black" style="background: white;margin-left: 10px;">
		<tr>
			<th style="padding: 10px; text-align: center;font-size: 20px;"><span class="badge badge-danger" style="padding: 10px">Farmer Name</span></th>
			<th style="padding: 10px;text-align: center;font-size: 20px;"><span class="badge badge-danger" style="padding: 10px">Certificate No.</span></th>
			...
			<th style="padding: 10px;text-align: center;font-size: 20px;"><span class="badge badge-warning" style="padding: 10px">View App.</span></th>
		...
		if(!mysqli_connect_error()){
			...
			WHERE `availableproducts`.`productVerified`=1 ORDER BY `availableproducts`.`availableDate` ASC";
					...
					<tr>
						...
						<td style="text-align: center; padding: 10px;">
							<form method="GET" action="./ViewApplicantForm">
								...
								<button style="margin-top: 2px;" class="btn btn-warning" type="submit" value="'.$row['userID'].'"><b>View App.</button>
							</form>
						</td>
