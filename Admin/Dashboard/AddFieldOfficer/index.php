...
<body>
	...
	<table border="2px solid black" style="background: white;margin-left: 10px;">
		<tr>
			...
			<th style="padding: 10px;text-align: center;font-size: 20px;"><span class="badge badge-warning" style="padding: 10px">View App. & Make FO</span></th>
					...
					<tr>
						...
						<td style="text-align: center; padding: 10px;">
							<form method="GET" action="./ViewApplicantForm">
								...
								<button style="margin-top: 2px;" class="btn btn-warning" type="submit" value="'.$row['userID'].'"><b>View App. & Make FO</button>
							</form>
						</td>
