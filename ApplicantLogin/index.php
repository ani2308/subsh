...
if (array_key_exists("users", $array_response)) {
    ...
    if(!mysqli_connect_error()){
        ...
        if(mysqli_num_rows($result)>0){
            ...
            if($row['formStatus1']!=1){
                header("Location: ../RegisterApplicant/RegistrationForm/1/index.php");
                exit;
            }
            if($row['formStatus2']!=1){
                header("Location: ../RegisterApplicant/RegistrationForm/2/index.php");
                exit;
            }
            if($row['formStatus3']!=1){
                header("Location: ../RegisterApplicant/RegistrationForm/3/index.php");
                exit;
            }
            if($row['formStatus4']!=1){
                header("Location: ../RegisterApplicant/RegistrationForm/4/index.php");
                exit;
            }
