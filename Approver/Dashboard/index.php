...
<body>
            ...
            <ul class="list-unstyled components">
                ...
                <li class="">
                    ...
                    <ul class="collapse list-unstyled" id="homeSubmenu">
                        ...
                        <li>
                            <a href="#" onclick="pendingApprovalsNominee()">Pending Nominee Approvals</a>
                        </li>
                        <li>
                            <a href="#" onclick="approvedApplicantsNominee()">Approved Nominee</a>
                        </li>
                    </ul>
                </li>
    ...
    <script type="text/javascript">
        ...
        function pendingApprovalsNominee() {
          document.getElementById("contentFrame").src = "./PendingApprovalsNominee/";
        }

        function approvedApplicantsNominee(){
            document.getElementById("contentFrame").src = "./ApprovedApplicantsNominee/";
        }
