var jic = {
        ...
        upload: function(photo_comprsd_img, photo_name, photo_file_name,applicantUTRNumber, applicantUTRNumberVal, applicantPaymentDate, applicantPaymentDateVal, upload_url, successCallback, errorCallback, duringCallback, customHeaders){
            ...
            var fdImg2=['Content-Disposition: form-data; name="'+applicantUTRNumber+'";','', applicantUTRNumberVal, '--' + boundary ];
            var fdImg3=['Content-Disposition: form-data; name="'+applicantPaymentDate+'";','', applicantPaymentDateVal, '--' + boundary + '--'];
